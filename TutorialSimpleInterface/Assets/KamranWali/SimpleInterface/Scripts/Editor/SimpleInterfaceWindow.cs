...
namespace KamranWali.SimpleInterface.Editor
{
    public class SimpleInterfaceWindow : EditorWindow
    {
        ...
        private BaseLayout _customLayout;
        ...
        private void Setup() 
        {
            ...
            _customLayout = new CustomLayout(Repaint);
            ...
            _customLayout.AddHideLayout(_fixedPositionLayout);
            _customLayout.AddHideLayout(_offsetPositionLayout);
            ...
            _manager.AddLayout(_customLayout);
        ...
        private Vector3 GetActualPosition(Vector3 position)
        {
            ...
            else if (_customLayout.IsShown()) return _customLayout.GetPosition(position);
